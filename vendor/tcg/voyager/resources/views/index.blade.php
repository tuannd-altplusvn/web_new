...
@section('content')
    <div class="page-content">
        <div class="widgets">
            ...
            <?php } ?>
            <?php if (Illuminate\Support\Facades\Schema::hasTable(with(new TCG\Voyager\Models\Transaction())->getTable())) { ?>
            <div class="panel widget center bgimage" style="background-image:url({{ config('voyager.assets_path') }}/images/widget-backgrounds/04.png);">
                ...
                <div class="panel-content">
                    ...
                    <?php $transaction_count = TCG\Voyager\Models\Transaction::count(); ?>
                    <h4>{{ $transaction_count }} Transaction(s)</h4>
                    <p>You have {{ $transaction_count }} Transaction in your database. Click on 'View All Transaction' below to view all Transaction.</p>
                    <a href="{{ route('voyager.transactions.index') }}" class="btn btn-primary">View All Transaction</a>
                </div>
            </div>
            <?php } ?>
            <?php if (Illuminate\Support\Facades\Schema::hasTable(with(new TCG\Voyager\Models\Product())->getTable())) { ?>
            <div class="panel widget center bgimage" style="background-image:url({{ config('voyager.assets_path') }}/images/widget-backgrounds/03.png);">
                ...
                <div class="panel-content">
                    ...
                    <?php $product_count = TCG\Voyager\Models\Product::count(); ?>
                    <h4>{{ $product_count }} Product(s)</h4>
                    <p>You have {{ $product_count }} Products in your database. Click on 'View All Products' below to view all products.</p>
                    <a href="{{ route('voyager.products.index') }}" class="btn btn-primary">View All Posts</a>
                </div>
            </div>
            <?php } ?>
